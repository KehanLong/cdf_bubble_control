...
def save_dataset(configurations, points, cdf_values, filename):
    os.makedirs(os.path.dirname(filename), exist_ok=True)
    np.savez(filename, configurations=configurations, points=points, cdf_values=cdf_values)
...
def main():
    ...
    link_lengths = [2, 2, 2, 2]  # N-link robot arm
    num_points = 2000
    num_configs = 200
    num_zero_configs = 5000 
    ...
    save_dataset(configs, points, cdf_values, 'cdf_dataset/robot_cdf_dataset_4_links.npz')
